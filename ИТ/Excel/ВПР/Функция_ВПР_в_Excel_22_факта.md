...
![Функция ВПР в Excel 22 факта 01](/ИТ/Excel/ВПР/Функция_ВПР_в_Excel_22_факта/01.png "Как расшифровываются параметры ВПР?"){.align-center}
...
![Функция ВПР в Excel 22 факта 02](/ИТ/Excel/ВПР/Функция_ВПР_в_Excel_22_факта/02.png "ВПР пригодится, чтобы объединять данные из разных таблиц"){.align-center}
...
![Функция ВПР в Excel 22 факта 03](/ИТ/Excel/ВПР/Функция_ВПР_в_Excel_22_факта/03.png "Может помочь классифицировать данные"){.align-center}
...
![Функция ВПР в Excel 22 факта 04](/ИТ/Excel/ВПР/Функция_ВПР_в_Excel_22_факта/04.png "Абсолютные ссылки облегчают и ускоряют работу с ВПР"){.align-center}
...
![Функция ВПР в Excel 22 факта 05](/ИТ/Excel/ВПР/Функция_ВПР_в_Excel_22_факта/05.png "Именованные диапазоны облегчают понимание формул и ещё больше упрощают работу"){.align-center}
...
![Функция ВПР в Excel 22 факта 06](/ИТ/Excel/ВПР/Функция_ВПР_в_Excel_22_факта/06.gif "Вставка столбца может «сломать» ваши вычисления"){.align-center}
...
![Функция ВПР в Excel 22 факта 07](/ИТ/Excel/ВПР/Функция_ВПР_в_Excel_22_факта/07.gif "Индекс столбца можно рассчитать автоматически"){.align-center}
...
![Функция ВПР в Excel 22 факта 08](/ИТ/Excel/ВПР/Функция_ВПР_в_Excel_22_факта/08.png "Используйте ВПР + ПОИСКПОЗ для полностью динамического индекса столбца"){.align-center}
...
![Функция ВПР в Excel 22 факта 09](/ИТ/Excel/ВПР/Функция_ВПР_в_Excel_22_факта/09.png "Можно использовать символы подстановки для определения частичного соответствия"){.align-center}
...
![Функция ВПР в Excel 22 факта 10](/ИТ/Excel/ВПР/Функция_ВПР_в_Excel_22_факта/10.png "Вместо ошибки #Н/Д можно показать любое сообщение"){.align-center}
...
![Функция ВПР в Excel 22 факта 11](/ИТ/Excel/ВПР/Функция_ВПР_в_Excel_22_факта/11.png "Числа, записанные как текст, могут стать причиной ошибки"){.align-center}
...
![Функция ВПР в Excel 22 факта 12](/ИТ/Excel/ВПР/Функция_ВПР_в_Excel_22_факта/12.png "ВПР нужна для замены вложенных операторов ЕСЛИ"){.align-center}
