...
Если несовпадение форматов встречается редко, то можно просто исправить формат записи данных. Измените формат ячейки на текстовый и пересохраните ее содержание (<kbd>F2</kbd> и затем <kbd>ENTER</kbd>). Содержимое будет преобразовано в текст.
